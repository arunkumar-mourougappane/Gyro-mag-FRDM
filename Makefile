...
OBJECTS += main.o
 ...
 SYS_OBJECTS += mbed/TARGET_K64F/TOOLCHAIN_GCC_ARM/except.o
 ...
 SYS_OBJECTS += mbed/TARGET_K64F/TOOLCHAIN_GCC_ARM/mbed_fault_handler.o
 ...
 SYS_OBJECTS += mbed/TARGET_K64F/TOOLCHAIN_GCC_ARM/qspi_api.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=$(EPOCHREALTIME)
...
CXX_FLAGS += -DMBEDTLS_PSA_CRYPTO_C
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1573273781.53
...
ASM_FLAGS += -DMBEDTLS_PSA_CRYPTO_C
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/0/07cde1d09495fdcb47d5326cd6c636c6/9250_mag_frdm/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
